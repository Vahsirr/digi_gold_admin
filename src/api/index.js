...
const API_BASE_URL = import.meta.env.VITE_API_URL || 'https://digi-gold-backend.vercel.app/api';
...
export const uploadCarouselImage = (data) =>
  api.post('/admin/carousel', data);
